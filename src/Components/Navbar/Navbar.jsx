...
import Darksmode from "./Darksmode"
const Menu = [
    {
      id: 1,
      name: "Home",
...
const Navbar = ({handleorderpopup}) => {
  return (
    <div className="shadow-md  dark:bg-slate-800 bg-white dark:bg-text-white duration-200 relative z-40
    ">
        ...
        <div data-aos="zoom-in" className="flex justify-center">
            ...
            >
                        ...
                        <li className="group relative cursor-pointer">
                            <a href="#" className="items-center flex gap-[2px] py-2" >
                                Tranding Products 
                                <span>
                                <FaCaretDown 
                            ...
                            <div className="absolute z-[9999] hidden group-hover:block w-[200px] rounded-md bg-white p-2 text-black shadow-md ">
                                <ul>
                                    ...
                                    <li key={data.id}>
                                        <a href={data.link} className="inline-block rounded-md w-full p-2 hover:bg-primary/20">
                                        {data.name}</a>
                                    </li>
                                    })}
                                </ul>
